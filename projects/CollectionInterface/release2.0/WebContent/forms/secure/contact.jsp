...
<script type='text/javascript'>
	function sendToOwner() {
		...
		EmailManager.sendRequestToOwner(datasourceId, siteId, firstname,
				lastname, email, telephone, comments, {
...
<body>
   <div id="page">
      ...
      <%
         ...
         out.println(String.format("Regarding Data Source <b>'%s'</b>.", ds.getName()));
      %>
               </td>
            </tr>
            <tr>
            ...
            <tr>
               <td class="labelCol"><label for="email">Email Address *</label></td>
            ...
            <tr>
               <td class="labelCol"><label for="comments">Comments *</label></td>
               <td class="fieldCol"><textarea name="comments" id="comments" maxlength="1000" cols="40" rows="15"></textarea></td>
            </tr>
            <tr>
               <td colspan="2" align="right"><input type="button" value="Send" onclick="sendToOwner()"></td>
            </tr>
         </table>
      </div>
