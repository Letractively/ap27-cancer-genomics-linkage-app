...
<head>
	...
	<script language="javascript">
		function resetPassword(form) {
			PersonManager.getPersonByEmail(form.email.value, {
...
<body>
	<div id="page" style="width:1050px;text-align:center;min-height:700px">
		...
		<div id="maintree" style="text-align:left; min-height:300px" class="clearfix">
			...
			<form method="POST" action='../secure/accounts.jsp' onsubmit='resetPassword(this)'>
		  	<table cellpadding="2" border="0" cellspacing="0" style="margin-left:auto; margin-right:auto">
		  		<tr>
		  			<td colspan="2">
		  			<label id="emailErrMsg" class="errMsg">Email (<span id="emailErr"></span>) does not exists in the datasbase.</label>
